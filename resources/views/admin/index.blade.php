...
<div class="container">
  <div class="page-inner">
    ...
    >
      <div>
        <h3 class="fw-bold mb-3">TAAN Dashboard</h3>
        <h6 class="op-7 mb-2">Welcome! Sandip</h6>
      </div>
      <div class="ms-md-auto py-2 py-md-0">
        <a href="#" class="btn btn-label-info btn-round me-2">Manage</a>
        <a href="{{route('admin.member')}}" class="btn btn-primary btn-round">Add Member</a>
      </div>
    </div>
    <div class="row">
        ...
        <div class="card card-stats card-round">
          <div class="card-body">
            <div class="row align-items-center">
              ...
              <div class="col col-stats ms-3 ms-sm-0">
                <div class="numbers">
                  <p class="card-category">Total Trail</p>
        ...
        <div class="card card-stats card-round">
          <div class="card-body">
            <div class="row align-items-center">
              ...
              <div class="col col-stats ms-3 ms-sm-0">
                <div class="numbers">
                  <p class="card-category">Trail Packages</p>
