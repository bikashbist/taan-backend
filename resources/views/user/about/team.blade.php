                ...
                <div class="row g-4 justify-content-center ">
                        ...
                        <div class="teams__details__list">
                            <div class="teams__details__list__box">
                                <div class="logo-img position-relative">
                                    <img src="{{ asset('user/images/team/ram-sir.jpg') }}"
                                    alt="" class="img">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="teams__details__list">
                            <div class="teams__details__list__box">
                                <div class="logo-img position-relative">
                                    <img src="{{ asset('user/images/team/sarita-simkhada-finace-officer.jpg') }}"
                                    alt="" class="img">
                                    <a class="profile-btn" href="{{route('user.team-profile')}}">View Profile <i class="fa-solid fa-eye"></i></a>
                   ...
                   <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="teams__details__list">
                            <div class="teams__details__list__box">
                                <div class="logo-img position-relative">
                                    <img src="{{ asset('user/images/team/ina-2.jpg') }}"
                                    alt="" class="img">
                                    <a class="profile-btn" href="{{route('user.team-profile')}}">View Profile <i class="fa-solid fa-eye"></i></a>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="teams__details__list">
                            <div class="teams__details__list__box">
                                <div class="logo-img position-relative">
                                     <img src="{{ asset('user/images/team/ambika.jpg') }}"
                                    alt="" class="img">
                                    <a class="profile-btn" href="{{route('user.team-profile')}}">View Profile <i class="fa-solid fa-eye"></i></a>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="teams__details__list">
                            <div class="teams__details__list__box">
                                <div class="logo-img position-relative">
                                    <img src="{{ asset('user/images/team/raju.jpg') }}"
                                    alt="" class="img">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="teams__details__list">
                            <div class="teams__details__list__box">
                                <div class="logo-img position-relative">
                                    <img src="{{ asset('user/images/team/tek-bdr-lama.jpg') }}"
                                    alt="" class="img">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="teams__details__list">
                            <div class="teams__details__list__box">
                                <div class="logo-img position-relative">
                                    <img src="{{ asset('user/images/team/laxmi_bhattarai.jpg') }}"
                                    alt="" class="img">
