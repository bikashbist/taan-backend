      ...
      <div class="row">
        ...
        <div class="col-lg-6">
            <div class="banner2-card five">
                <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home3/banner4-card-img2.png" alt="">
        ...
        <div class="col-lg-6">
            <div class="banner4-card four">
                <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home3/banner4-card-img1.png" alt="">
            ...
            <div class="col-4 col-md-2 ">
                ...
                <div class="card text-center">
                    <img class="card-img-top bg-success"
                        src="images/trail/everest-base-camp-trek-with-helicopter-return.webp" alt="img" />
                    <img class="card-img-avatar rounded-circle" src="images/trail/binod-sapkota.jpg" alt="img" />
                    <div class="card-body">
                        <h5 class="card-title">Nepal Trek Adventure and Expedition</h5>
               
                        <a href="member-page.html" class="btn-view-more">View Details</a>
                    </div>
                </div>
            ...
            <div class="col-4 col-md-2 ">
                ...
                <div class="card text-center h-100">
                    <img class="card-img-top"
                        src="images/banner/banner.jpg" alt="img" />
                    <img class="card-img-avatar rounded-circle" src="images/dummy-male.jpg" alt="img" />
                    <div class="card-body">
                        <h5 class="card-title">Travel agency names</h5>
